...
const SpConfirmedAppointments = (props) => {
  const { confirmed, onConfirmed } = props;
  ...
  const changeFinishedStatus = async (id, appointment) => {
...
export default SpConfirmedAppointments;
